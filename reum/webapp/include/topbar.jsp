...
<div id="welcomeLine" class="row">
	<div class="span6">
		WelCome! <strong> ${sessionScope.SESS_NAME} ^_^</strong>
	</div>
	<div class="span6">
					...
					<ul class="dropdown-menu">
						<c:choose>
							...
							<c:otherwise>
								...
								<li class="divider"></li>
								<li><a href="management.jsp"
									class="dropdown-item has-icon loginCheck">마이페이지 홈</a></li>
								<li><a href="management.jsp"
									class="dropdown-item has-icon loginCheck">최근 본 상품</a></li>
								<li><a href="management.jsp"
